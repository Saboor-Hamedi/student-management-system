                ...
                <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                  ...
                  <div class=" row">
                    ...
                    <div class="col-lg-12 mb-2">
                      <input type="hidden" class="form-control" name="user_main_id" placeholder="User Main ID"
                        value="<?php echo $user_id; ?>">
                    </div>
                    <div class="col-md-6">
                      <div class="form-group">
                        <input type="text" class="form-control" name="user_country" placeholder="Where are you from ?"
                    ...
                    <div class="col-md-6">
                      <div class="form-group">
                        <input type="text" class="form-control" name="user_post_code"
                          placeholder="Post Code Like (13842)" value="<?php echo $user_post_code; ?>">
                        <span class="error">
                          <?php
                            if (isset($errors['user_post_code'])) {
                ...
                <form method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <input type="text" class="form-control" name="user_address" placeholder="Where do you live ?"
